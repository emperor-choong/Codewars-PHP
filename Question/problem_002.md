...
## Your Task
Please help `Farmer Arepo` inspecting tablets to find out if any form a valid [Sator Square](https://en.wikipedia.org/wiki/Sator_Square)!

![Sator Square](../Image/image_002.jpeg)

## The Square
is a two-dimentional palindrome observing rotational symmetry, made from words of equal length that can be read in these 4 ways:
